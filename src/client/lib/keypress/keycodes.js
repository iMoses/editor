...
export const metaKey = (navigator.userAgent.indexOf('Mac OS X') !== -1) ? 'cmd' : 'ctrl';

export const modifierKeys = ['meta', 'alt', 'option', 'ctrl', 'shift', 'cmd'];

export const modifierEventMapping = {
    'cmd': 'metaKey',
    'ctrl': 'ctrlKey',
    'shift': 'shiftKey',
    'alt': 'altKey'
